      ...
      content: [
        ...
        InformeBuilder.tableBuilder(
          ...
          [
            ...
            [
              kpis.nuevosAño ? `Nuevos ${kpis.nuevosAño}` : 'Última generación',
              String(kpis.nuevos),
            ],
          ],
          ['*', 140],
        ...
        {
          text: 'Situación académica actual',
          style: 'header',
        ...
        {
          text: 'Becarios por generación de ingreso',
          style: 'header',
          margin: [0, 16, 0, 6] as [number, number, number, number],
        },
        InformeBuilder.tableBuilder(
        ...
        {
          text: 'Estado actual por cohorte',
          style: 'header',
          margin: [0, 16, 0, 6] as [number, number, number, number],
        },
        InformeBuilder.tableBuilder(
